...
@click.option('-o', '--output', default='.', type=click.Path(path_type=Path),
    ...
    try:
        ...
        for variable in var:
            if '=' in variable:
                ...
                console.print(f"⚠️  Invalid variable format: {variable} (expected key=value)", 
                            style="yellow")
        ...
        with Progress(
            ...
            generator.generate(structure, output, progress_callback=lambda: progress.advance(task))
